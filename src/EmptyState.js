...
const ComboCard = ({
  ...
  useEffect(() => {
    const comboInCart = cart.find(
      (item) => item.isCombo && item.combo_id === combo.combo_id
    );
  ...
  const getPrestigeBadge = () => {
    ...
    const {
      ...
      color,
      text,
    } = badges[combo.combo_type] || badges.standard;
  ...
  const isComboVeg = combo.combo_items.every(
        ...
        <div className="mt-auto">
          <div className="flex flex-col justify-between items-start mb-4">
            ...
            <div className="space-x-2 space-y-2">
              ...
              {combo.has_discount === "yes" && (
                <span
                  className={`inline-flex items-center px-2 py-1 rounded-full text-[0.9rem] font-semibold ${
                    theme === "light"
                      ? "bg-green-100 text-green-800"
                ...
                >
                  Save{" "}
                  {(
                    ((combo.cost - combo.discounted_cost) / combo.cost) *
                    100
                  ).toFixed(0)}
                  %
                </span>
...
const EmptyState = ({
  ...
  return (
    <div className="h-full flex flex-col pt-3 space-y-6 max-w-4xl mx-auto no-scrollbar">
      ...
      >
        <h1
          className={`text-2xl font-extrabold bg-gradient-to-r ${headingGradient} text-transparent bg-clip-text`}
        >
        ...
        >
          Ask me anything about our menu, and I'll guide you to a dish worth
          savoring.
        </p>
      </motion.div>
      ...
      <div className="flex-grow flex flex-col">
        <h2
          className={`text-lg font-extrabold pl-3 text-left bg-gradient-to-r ${headingGradient} text-transparent bg-clip-text mb-4`}
        >
                ...
                >
                  ...
                  <div className="relative h-40">
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex justify-between items-end">
                      <h3
                        className="font-bold text-white drop-shadow-md leading-tight text-sm"
            ...
            {[...Array(6)].map((_, index) => (
              <div
                ...
                className={`h-1 rounded-full transition-all duration-300 ${
                  scrollPosition >= index / 6 &&
                  scrollPosition <= (index + 1) / 6
                    ? "w-4 bg-blue-600"
                    : "w-2 bg-gray-300"
                }`}
              />
      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="relative flex-grow">
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.2, ease: "easeOut" }}
            onScroll={() =>
              handleScroll(comboCarouselRef, setComboScrollPosition)
            }
          >
            <AnimatePresence>
          ...
          <div className="flex justify-center mt-2 space-x-1">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className={`h-1 rounded-full transition-all duration-300 ${
                  comboScrollPosition >= index / 6 &&
                  comboScrollPosition <= (index + 1) / 6
                    ? "w-4 bg-blue-600"
                    : "w-2 bg-gray-300"
                }`}
              />
      ...
      <p
        className={`text-xs pb-7 text-center ${
          theme === "light" ? "text-gray-500" : "text-gray-400"
        }`}
      >
        Explore favorites, combos, dietary choices, and flavors designed to
        delight.
        <br />
